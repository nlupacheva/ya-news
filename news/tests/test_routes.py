...
class TestRoutes(TestCase):
    ...
    def test_pages_availability(self):
        """Главная, деталь новости, логин и регистрация доступны анониму (200)."""
        urls = (
            ('news:home', None),
    ...
    def test_availability_for_comment_edit_and_delete(self):
        """Редактирование/удаление комментария: автор — 200; чужой — 404."""
        users_statuses = (
    ...
    def test_redirect_for_anonymous_client(self):
        """Аноним на edit/delete комментария — редирект на логин с ?next=..."""
